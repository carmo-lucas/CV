...
\skill{R}{4}{Conhecimento adquirido ao longo de 5 anos. Análise e visualização de dados}
\skill{python}{1}{Projetos de mineração de dados usando BeautifulSoup}

\skill{Inglês}{5}{Um ano de experiência morando na Austrália.}
